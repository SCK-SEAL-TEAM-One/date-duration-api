...
func Test_GetDays_By_hours_189768_Should_Get_Days_7907(t *testing.T) {
	expectedResult := 7907
	duration := Duration{
		Hours: 189768,
	}
...
func Test_GetDays_By_hours_189504_Should_Get_Days_7896(t *testing.T) {
	expectedResult := 7896
	duration := Duration{
		Hours: 189504,
	}
...
func Test_GetDays_By_hours_204624_Should_Get_Days_8526(t *testing.T) {
	expectedResult := 8526
	duration := Duration{
		Hours: 204624,
	}
...
func Test_GetWeeks_By_Days_7907_Should_Get_TotalWeeks_1129_DaysOfWeek_4(t *testing.T) {
...
func Test_GetWeeks_By_Days_7896_Should_Get_TotalWeeks_1128_DaysOfWeek_0(t *testing.T) {
	expectedResult := Weeks{
		TotalWeeks: 1128,
		DaysOfWeek: 0,
	}
...
func Test_GetWeeks_By_Days_8526_Should_Get_TotalWeeks_1218_DaysOfWeek_0(t *testing.T) {
	expectedResult := Weeks{
		TotalWeeks: 1218,
		DaysOfWeek: 0,
	}
...
func Test_GetMonths_By_StartYear_1997_StartMonth_10_StartDay_16_Should_Get_TotalMonths_259_DaysOfMonth_25(t *testing.T) {
...
func Test_GetMonths_By_StartYear_1997_StartMonth_10_StartDay_27_Should_Get_TotalMonths_259_DaysOfMonth_14(t *testing.T) {
	expectedResult := Months{
		TotalMonths: 259,
		DaysOfMonth: 14,
	}
...
func Test_GetMonths_By_StartYear_1996_StartMonth_2_StartDay_5_Should_Get_TotalMonths_280_DaysOfMonth_5(t *testing.T) {
	expectedResult := Months{
		TotalMonths: 280,
		DaysOfMonth: 5,
	}
